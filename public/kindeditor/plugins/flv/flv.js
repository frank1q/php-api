	...
	self.plugin.flv = {
		edit : function() {
			var html = [
				...
				'<div class="ke-dialog-row">支持FLV,MP4,F4V编码格式：</div>',
				//url
			...
			var dialog = self.createDialog({
				...
				yesBtn : {
					...
					click : function(e) {
						...
						+'f:"'+url+'",\r\n'
						+'fc:0,p:1,e:1,m:0,i:""};\r\n'
						+'CKobject.embedSWF("'+K.basePath+'plugins/ckplayer/ckplayer.swf","a1","ckplayer_a1",'+width+','+height+',flashvars); \r\n'
						+'var video={url:"video/flv"}; \r\n'
						+'var support=["iPad","iPhone","ios","android+false","msie10+false"];\r\n'
						+'CKobject.embedHTML5("a1","ckplayer_a1",'+width+','+height+',video,flashvars,support);\r\n'
						+'</script>';
						//alert(video_code);
