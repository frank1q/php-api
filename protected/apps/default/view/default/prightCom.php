       ...
       <div class="block box">
          ...
          <ul class="bock-listp yx-u">
              {hot:{table=(photo) field=(id,title,picture,method) order=(hits desc,id desc) where=(ispass='1') limit=(4)}}
               <li><a class="box" target="_blank"  title="[hot:title]" href="[hot:url]" ><img  src="[hot:picturepath]" alt="[hot:title]" width="120" height="91"></a><h2 style="color:[hot:color]">[hot:title]</h2></li>
              {/hot}
          </ul>
       </div>
