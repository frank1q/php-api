...
<script language="javascript">
  $(function ($) { 
	...
	//表单验证
	var items_array = [
		{ name:"opassword",require:false,simple:"旧密码"},
		{ name:"rpassword",min:6,require:false,simple:"新密码",focusMsg:'大于6位'},
		{ name:"spassword",type:'eq',to:'rpassword',require:false,simple:"确认密码",focusMsg:'再次输入密码'},
...
<div class="list_head_m">
         ...
         <table width="100%" border="0" cellpadding="0" cellspacing="1"   class="all_cont">
          ...
          <tr>
            ...
            <td align="left" class="inputhelp">如果不需要修改密码，请不要填写旧密码</td>
          </tr> 
          <tr>
