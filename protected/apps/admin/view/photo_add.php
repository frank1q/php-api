...
KindEditor.ready(function(K) {
	edcon=K.create('#content', {
		...
		filterMode:false,
		uploadJson : "{url('photo/UploadJson',array('phpsessid'=>session_id()))}",
...
<div class="list_head_m"><div class="list_head_ml">当前位置：【图集添加】</div></div>
  ...
  <table class="all_cont" width="100%" border="0" cellpadding="5" cellspacing="1"   >
            ...
            <td align="left"><p>
                  <?php 
                      ...
                      foreach($sortlist as $vo){
                          ...
                          $exsort.= $vo['deep']==1?'</p><p class="exsort">'.$space.'<input type="checkbox" '.$ifable.' name="exsort[]" value="'.$vo['id'].'">'.$vo['name'].'&nbsp;<a class="fold" onclick="return false;"></a></p><p style="display:none">':$space.'<input type="checkbox" '.$ifable.' name="exsort[]" value="'.$vo['id'].'">'.$vo['name'].'<br>';
                      }
                        echo $exsort;
                     }
                  ?>
    ...
    <tr>
      ...
      <td align="left"  colspan="2"><textarea name="content" id="content" style=" width:100%;height:400px;visibility:hidden;"></textarea></td>
    </tr>
    <tr>
