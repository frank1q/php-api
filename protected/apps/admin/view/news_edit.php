...
KindEditor.ready(function(K) {
	edcon=K.create('#content', {
		...
		filterMode:false,
		uploadJson : "{url('news/UploadJson',array('phpsessid'=>session_id()))}",
         ...
         <table class="all_cont" width="100%" border="0" cellpadding="5" cellspacing="1"   >
          ...
          <tr>
            ...
            <?php if(!empty($info['picture']) && $info['picture']!='NoPic.gif'){ ?>
                [<a href="javascript:void(0);" id="covershow">＋编辑封面</a>]
                <div class="arcover">
            ...
            <td class="inputhelp">直接上传方式优先级高于内容获取方式</td>
          </tr> 
          <tr>
          ...
          <tr>
            ...
            <td align="left" colspan="2"><textarea name="content" id="content" style=" width:100%;height:450px;visibility:hidden;">{$info['content']}</textarea><br><div id="saveimage" class="btn">图片本地化</div></td>
          </tr>
          <tr>
