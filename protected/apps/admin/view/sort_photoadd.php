...
<script language="javascript">
  $(function ($) { 
	...
	$("#ifnums").click(function(){
		var tagit=$("#sortmodel");
	    if(!!$(this).attr("checked"))  tagit.html('<textarea name="sortname" id="sortname" cols="25" rows="8"></textarea>');
		else tagit.html('<input type="text" name="sortname" id="sortname">');
		$("#info").skygqCheckAjaxForm({
		    items			: items_array
	    });
	});
          ...
          <form enctype="multipart/form-data" action="{url('sort/photoadd')}"  method="post" id="info">
          ...
          <tr>
            ...
            <td align="left">
             ...
             &nbsp;&nbsp;&nbsp; <input id="ifnums" name="ifnums" type="checkbox" value="1">批量
            </td>
          ...
          <tr>
            ...
            <td align="left" id="sortmodel">
              <input type="text" name="sortname" id="sortname">
            </td>
            <td align="left" class="inputhelp">请填写要添加分类的名称,批量添加时每行一个栏目名称</td>
          </tr>
          <tr>
