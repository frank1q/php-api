          ...
          <?php 
                 if(!empty($list)){
                      foreach($list as $vo){
                          ...
                          $cont.= $vo['picture']=='NoPic.gif'?'':'<span id="c'.$vo['id'].'"><a title="点击查看封面" href="'.$path.$vo['picture'].'" onClick="return hs.expand(this);"><img src="'.$public.'/images/pic.png"></a><a onClick="return delcover(this);" href="#" class="highslide-caption" alt="'.$vo['picture'].'" title="'.$vo['id'].'"><img src="'.$public.'/images/del.gif">删除</a></span>';
