...
KindEditor.ready(function(K) {
  ...
  $('#saveimage').click(function(){
	...
	$("#cut").click(function(){//剪切图片
		...
		$.post("{url('sort/cutcover')}", { name: name, x1: x1, y1: y1, w: w, h: h,thumb_w: thumb_w,file:'pages/image'}, 
			   function(data){
				   if(data){
					$("#coverimg").hide();
...
<div class="list_head_m">
        ...
        <form enctype="multipart/form-data"  action="{url('sort/pageedit',array('id'=>$id,'pageid'=>$info1['id']))}"  method="post" id="info">
         <table width="100%" border="0" cellpadding="0" cellspacing="1"   class="all_cont">
          ...
          <tr>
            ...
            <td align="left" colspan="2"><textarea name="content" id="content" style=" width:100%;height:450px;visibility:hidden;">{$info1['content']}</textarea><br><div id="saveimage" class="btn">图片本地化</div></td>
          </tr>
          <tr>
